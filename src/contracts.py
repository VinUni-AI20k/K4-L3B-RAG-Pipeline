...
RetrievalMethod = Literal["dense", "bm25", "hybrid", "gemini_fallback"]
RetrievalSource = Literal["hybrid", "gemini_fallback", "none"]
...
def validate_search_results(
    ...
    *,
    ...
    ids: list[str] = []
    scores: list[float] = []
    valid_methods = {"dense", "bm25", "hybrid", "gemini_fallback"}
    for item in results:
